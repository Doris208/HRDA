"""
HRDA on ISPRS Potsdam RGB -> Vaihingen IRRG.
"""

_base_ = [
    '../_base_/default_runtime.py',
    '../_base_/models/daformer_sepaspp_mitb5.py',
    '../_base_/datasets/uda_potsdamRGB_to_vaihingenIRRG_1024x1024.py',
    '../_base_/uda/dacs.py',
...
name = 'potsdamRGB2vaihingenIRRG_hrda'
exp = 'isprs_uda'
name_dataset = 'potsdamRGB2vaihingenIRRG_1024x1024'
